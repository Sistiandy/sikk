...
<html lang="en">
    ...
    <head>
        ...
        <title><?php echo (class_name() != '-') ? class_name() : 'SYSCMS'; ?> <?php echo isset($title) ? ' | ' . $title : null; ?></title>
            ...
            <div class="main_container">
                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        ...
                        <div class="sidebar-footer hidden-small">
                            ...
                            <?php echo form_open(site_url('student/auth/logout'), array('id' => 'formLogout')) ?>
                ...
                <div class="top_nav">
                        ...
                        if ($this->session->flashdata('success')) {
                            ...
                            $this->load->view('student/notification_success', $data);
                        }
                        if ($this->session->flashdata('failed')) {
                            $data['message'] = $this->session->flashdata('failed');
                            $this->load->view('student/notification_failed', $data);
                        }
                        ?>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        <img src="<?php echo media_url() ?>/images/user.png" alt=""><?php echo $text = ucfirst($this->session->userdata('student_name')); ?>
                                        <span class=" fa fa-angle-down"></span>
                                    </a>
                                    <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                        <li><a href="<?php echo site_url('student/dashboard') ?>">  Home</a>
                                        </li>
                                        <li><a href="<?php echo site_url('student/profile') ?>">  Profile</a>
                                        </li>
                                        <li>
                                        <center>
                                            <?php echo form_open(site_url('student/auth/logout')) ?>
                                            <input type="hidden" name="location" value="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']) ?>">
