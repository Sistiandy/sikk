...
class Dashboard extends CI_Controller {
    ...
    public function index() {
        ...
        $data['inputSum'] = count($this->Input_transaction_model->get());
        $data['input'] = $this->Input_transaction_model->get(array('limit' => 5));
        $data['outputSum'] = count($this->Output_transaction_model->get());
        $data['output'] = $this->Output_transaction_model->get(array('limit' => 5));
