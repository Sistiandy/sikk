...
class Input_transaction_model extends CI_Model {
    ...
    function get($params = array())
    {
        if(isset($params['id']))
        {
            $this->db->where('transaction.transaction_id', $params['id']);
        }
        ...
        $this->db->select('transaction.transaction_id, transaction_is_late, 
        ...
        $this->db->join('user', 'user.user_id = transaction.user_user_id', 'left');
