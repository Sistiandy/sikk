...
class Student_model extends CI_Model {
    ...
    function get($params = array()) {
        ...
        $this->db->select('student.user_user_id, user_name');
        
        $this->db->select('sum(input_transaction_value) AS kas');
        
        $this->db->join('input_transaction', 'input_transaction.student_student_id = student.student_id', 'left');
